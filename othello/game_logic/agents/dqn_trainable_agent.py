...
class DQNTrainableAgent(TrainableAgent):
    def __init__(self, color: Color, immediate_reward: ImmediateReward = None, board_size: int = 8,
        ...
        self.training_policy: AnnealingEpsilonGreedyPolicy = AnnealingEpsilonGreedyPolicy(self.start_epsilon, self.epsilon, self.epsilon_steps,
                                                                                          board_size, self.allow_exploration)
